...
1. Run `pip install -r requirements.txt` to instal dependencies
2. *(optional)* Download `ROAD_Waymo` from [here](https://console.cloud.google.com/storage/browser/waymo_open_dataset_road_plus_plus)
...
3. Run `python setup/get_road.py`
