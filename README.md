...
## Setup instructions
Consider using `conda` or `Docker` to isolate your other projects or applications you use. Take a note, that Python version must be `3.10.19` for this setup.
...
3. Run `python setup/get_mmaction2` to install [`MMAction2`](https://github.com/open-mmlab/mmaction2)
